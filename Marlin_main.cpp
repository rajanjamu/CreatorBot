...
const char* queued_commands_P= NULL; /* pointer to the current line in the active sequence of commands, or NULL when none */    //-------------added
...
{ 
  ...
  // RGB LED , uncomment if used
//   pinMode(MY_LED_RED ,OUTPUT);
//   pinMode(MY_LED_BLUE ,OUTPUT);
//   pinMode(MY_LED_GREEN ,OUTPUT);
//   
//   digitalWrite(MY_LED_RED, 0);
//   digitalWrite(MY_LED_BLUE, 0);
//   digitalWrite(MY_LED_GREEN, 1);
//   _delay_ms(200);
//   digitalWrite(MY_LED_RED, 0);
//   digitalWrite(MY_LED_BLUE, 1);
//   digitalWrite(MY_LED_GREEN, 0);
//   _delay_ms(200);
//   digitalWrite(MY_LED_RED, 0);
//   digitalWrite(MY_LED_BLUE, 1);
//   digitalWrite(MY_LED_GREEN, 1);
//   _delay_ms(200);
//   digitalWrite(MY_LED_RED, 1);
//   digitalWrite(MY_LED_BLUE, 0);
//   digitalWrite(MY_LED_GREEN, 0);
//   _delay_ms(200);
//   digitalWrite(MY_LED_RED, 1);
...
Sigma_Exit:
...
#endif
      analogWrite(MY_LED_RED, 0);  
      analogWrite(MY_LED_BLUE, 1);
      analogWrite(MY_LED_GREEN, 1);
  //    digitalWrite(FAN_PIN,LOW);   //------------------------------------------------------------------------------------------------------------
    ...
    case 84: // M84
      ...
      analogWrite(MY_LED_RED, 1);   
      analogWrite(MY_LED_BLUE, 1);
      analogWrite(MY_LED_GREEN, 0);
      }
      break;
    case 85: // M85
      if(code_seen('S')) {
